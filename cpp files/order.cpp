...
#include <iostream>
Order::Order(Trader& trader, Stock& stock,int quantity, double price)
...
int Order::get_id() const { return order_id; }
...
MarketBuyOrder::MarketBuyOrder(Trader& trader, Stock& stock, int quantity, double price)
...
MarketSellOrder::MarketSellOrder(Trader& trader, Stock& stock, int quantity, double price)
: Order(trader, stock, quantity, price) {}
...
LimitBuyOrder::LimitBuyOrder(Trader& trader,Stock& stock, int quantity, double max_price)
...
LimitSellOrder::LimitSellOrder(Trader& trader, Stock& stock, int quantity, double min_price)
